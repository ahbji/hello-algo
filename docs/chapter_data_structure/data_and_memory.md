...
![IEEE 754 标准下的 float 表示方式](https://github.com/ahbji/hello-algo/blob/main/docs/chapter_data_structure/data_and_memory.assets/ieee_754_float.png/?raw=true)
...
![内存条、内存空间、内存地址](https://github.com/ahbji/hello-algo/blob/main/docs/chapter_data_structure/data_and_memory.assets/computer_memory_location.png?raw=true)
